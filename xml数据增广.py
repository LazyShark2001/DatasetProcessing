# -*- coding=utf-8 -*-
'''
https://blog.csdn.net/jiayou2021/article/details/126246040
https://www.cnblogs.com/qqsj/p/17492360.html
'''
import time
import random
import copy
...
class DataAugmentForObjectDetection():
    ...
    #     sed = self.num
    #
    #     if sed % 3 == 0:  # 0.33的概率水平翻转，0.33的概率垂直翻转,0.33是对角反转
    #         flip_img = cv2.flip(flip_img, 0)  # _flip_x
    #         inver = 0
    #     elif sed % 3 == 1:
    #         flip_img = cv2.flip(flip_img, 1)  # _flip_y
    ...
    def dataAugment(self, img, bboxes):
        ...
        while change_num < 1:  # 默认至少有一种数据增强生效
            ...
            # if self.is_addNoise:
            #     if random.random() < self.add_noise_rate:  # 加gaosi噪声
            #         change_num += 1
...
if __name__ == '__main__':
    ...
    dataAug = DataAugmentForObjectDetection(cutout_rate=False)  # 数据增强工具类

    toolhelper = ToolHelper()  # 工具

    # 获取相关参数
    parser = argparse.ArgumentParser()
    parser.add_argument('--source_img_path', type=str, default=r'C:\Users\LazyShark\Desktop\RZB_NEW\aug\lousha\images')
    parser.add_argument('--source_xml_path', type=str, default=r'C:\Users\LazyShark\Desktop\RZB_NEW\aug\lousha\xmls')
    parser.add_argument('--save_img_path', type=str, default=r'C:\Users\LazyShark\Desktop\RZB_NEW\aug\lousha\images')
    parser.add_argument('--save_xml_path', type=str, default=r'C:\Users\LazyShark\Desktop\RZB_NEW\aug\lousha\xmls')
